...
public class MovieIDJsonHandlerCallback implements Handler.Callback {

	private final API storage;
	private final Context context;

	public MovieIDJsonHandlerCallback(Context context, API storage) {
	...
	public boolean handleMessage(final Message msg) {
		...
		try {
			...
			JSONObject movieJson = (JSONObject) msg.obj;
			...
			Movie movie = new Movie(title, uri, ID);
